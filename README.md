...
- Penrose quasicrystal relief disc
...
| --- | --- | --- | --- |
| `fractal` | string | `'mandelbulb'` | `'mandelbulb'`, `'mandelbox'`, `'menger'`, `'julia'`, `'apollonian'`, `'spherepack'`, `'encrusted'`, `'surfacepack'`, `'penrose'`, `'penrose-sponge'`, `'attractor'`, or `'lorenz'` |
...
- **Penrose relief:** a true P3 rhombus tiling engraved into a disc at two levels of its inflation hierarchy
